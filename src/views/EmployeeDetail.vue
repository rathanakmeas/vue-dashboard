...
const rankGradeMapping = {
  ...
  // National Election Committee (គ.ជ.ប) frameworks
  ...
  // Magistrate and Royal Decree frameworks
  'ក្របខណ្ឌចៅក្រម': [
    'ឧត្តមចៅក្រម(ក.១.)',
    'វរៈចៅក្រម(ក.២.)',
    'អនុចៅក្រម(ក.៣.)'
  ...
  'ក្របខណ្ឌព្រះរាជអាជ្ញា': [
    'ឧត្តមព្រះរាជអាជ្ញា(ក.១.)',
    'វរៈព្រះរាជអាជ្ញា(ក.២.)',
    'អនុព្រះរាជអាជ្ញា(ក.៣.)'
  ],
  // Prison Officer framework
  'ក្របខណ្ឌមន្រ្តីពន្ធនាគារ': [
    'ឧត្តមអគ្គានុរក្សពន្ធនាគារ',
    'វរអគ្គានុរក្សពន្ធនាគារ',
    'អគ្គានុរក្សពន្ធនាគារ',
    'អនុរក្សពន្ធនាគារ'
  ],
  // National Police framework
...
const rankClassMapping = {
  ...
  // National Election Committee (គ.ជ.ប) - No payscales
  'ឧត្តមមន្រ្តី': [],
  'វរមន្រ្តី': [],
  'អនុមន្រ្តី': [],
  'នាយក្រមការ': [],
  ...
  'ក្រមការ': [],
  'មន្រ្តីបោះឆ្នោតបឋម': [],
  // Magistrate framework payscales
  'ឧត្តមចៅក្រម(ក.១.)': [
    'ថ្នាក់លេខ១',
    'ថ្នាក់លេខ២',
    'ថ្នាក់លេខ៣',
  ...
  // Royal Decree framework payscales
  'ឧត្តមព្រះរាជអាជ្ញា(ក.១.)': [
    'ថ្នាក់លេខ១',
    'ថ្នាក់លេខ២',
    'ថ្នាក់លេខ៣',
  ...
  // Prison Officer framework payscales
  'ឧត្តមអគ្គានុរក្សពន្ធនាគារ': [
    'ថ្នាក់លេខ១',
    'ថ្នាក់លេខ២',
    'ថ្នាក់លេខ៣'
  ...
  // National Police framework payscales
  'នាយឧត្តមសេនីយ៍': [
    'នាយឧត្តមសេនីយ៍'
  ],
  'ឧត្តមសេនីយ៍': [
